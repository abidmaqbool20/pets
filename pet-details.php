				...
				<div class="com-padd">
					...
					<div class="list-pg-lt list-page-com-p">
							...
							<div class="list-pg-inn-sp">
								<div id="myCarousel" class="carousel slide" data-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="item active"> <img src="images/slider/p1.jpg" alt="Los Angeles"> </div>
										<div class="item"> <img src="images/slider/p2.jpg" alt="Chicago"> </div>
										<div class="item"> <img src="images/slider/p3.jpg" alt="New York"> </div>
										<div class="item"> <img src="images/slider/p4.jpg" alt="New York"> </div>
									</div>
						...
						<div class="pglist-p1 pglist-bg pglist-p-com">
							<div class="pglist-p-com-ti">
								<h3><span>About</span> American Property</h3> </div>
							<div class="list-pg-inn-sp">
								<div class="share-btn">
									<ul>
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							<div class="pglist-p-com-ti">
								<h3><span>Available</span> Properties</h3> </div>
							<div class="list-pg-inn-sp">
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/p1.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>Villas For Sale</h3></a>
										...
										<div class="list-room-type list-rom-ami">
											<ul>
												...
												<li><img src="images/icon/a7.png" alt=""> 2000 SF</li>
												<li><img src="images/icon/a4.png" alt=""> 4BHK </li>
												<li><img src="images/icon/a3.png" alt=""> Swimming Pool</li>
												<li><img src="images/icon/a2.png" alt=""> Parking</li>
												<li><img src="images/icon/a5.png" alt=""> Bathroom</li>
												<li><img src="images/icon/a6.png" alt=""> Modern Kitchen</li>
												<li><img src="images/icon/a9.png" alt=""> 24X7 Security</li>
												<li><img src="images/icon/a10.png" alt=""> House Keeping</li>
											</ul>
										</div> <span class="home-list-pop-rat list-rom-pric">$9640</span>
								...
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/p2.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>Individual Houses</h3></a>
										<div class="list-rat-ch list-room-rati"> <span>5.0</span> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> </div>
										<div class="list-room-type list-rom-ami">
											<ul>
												<li>
								...
								<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
									<!--LISTINGS IMAGE-->
									<div class="col-md-3"> <img src="images/room/p3.jpg" alt=""> </div>
									<!--LISTINGS: CONTENT-->
									<div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>Alaska Apartments</h3></a>
										<div class="list-rat-ch list-room-rati"> <span>5.0</span> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> </div>
										<div class="list-room-type list-rom-ami">
											<ul>
												<li>
										...
										</div> <span class="home-list-pop-rat list-rom-pric">$6512</span>
										<div class="list-enqu-btn">
											<ul>
												<li><a href="#!"><i class="fa fa-usd" aria-hidden="true"></i> Get Quotes</a> </li>
												<li><a href="#!"><i class="fa fa-commenting-o" aria-hidden="true"></i> Send SMS</a> </li>
					...
					<div class="list-pg-rt">
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							<div class="pglist-p-com-ti pglist-p-com-ti-right">
								<h3><span>Send</span> Inquiry</h3> </div>
								...
								<div class="list-pg-write-rev">
									<form class="col">
										...
										<div class="row">
											<div class="input-field col s12">
												<textarea id="re_msg" class="materialize-textarea"></textarea>
												<label for="re_msg">Write Message</label>
											</div>
										</div>
										<div class="row">
											<div class="input-field col s12"> <a class="waves-effect waves-light btn-large full-btn" href="#!">Submit Inquiry</a> </div>
