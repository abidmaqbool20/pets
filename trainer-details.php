			...
			<div class="">
				<div class="pg-elem-inn ele-btn">
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p1 pglist-p-com" id="ld-abour">
							<div class=" ele-btn">
								<div class="pglist-p-com-ti">
									<ul class="tabs pg-ele-tab" style="margin-bottom: 0;">
										<li class="tab col s2"><a href="#aboutsinfo">Info </a> </li>
										<li class="tab col s2"><a class="" href="#portfolios">PotFolio </a> </li>
										<li class="tab col s2 "><a href="#reviewes">Reviews</a> </li>
										<li class="tab col s2"><a href="#maplocation">Location</a> </li>
										<li class="tab col s2"><a href="#deals">Deals</a> </li>
									</ul>
								</div>
								<div class="tabline"></div>
								<div id="aboutsinfo" class="">
									<div class="pglist-p1 pglist-bg pglist-p-com">
										<div class="pglist-p-com-ti">
										<h3><span>About</span> Taj Luxury</h3> </div>
										<div class="list-pg-inn-sp">
											
											<p>Taj Luxury Hotels & Resorts presents award winning luxury hotels and resorts in India, Indonesia, Mauritius, Egypt and Saudi Arabia.It is a long established fact that a reader will be distracted by the readable content </p>
									...
									<div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
										<div class="pglist-p-com-ti">
											<h3><span>Basic</span> Info </h3> </div>
										<div class="list-pg-inn-sp">
									...
									<div class="pglist-p3 pglist-bg pglist-p-com" id="ld-roo">
										<div class="pglist-p-com-ti">
										<h3><span>Our </span> Services</h3> </div>
										<div class="list-pg-inn-sp">
											<div class="list-room-type list-rom-ami">
												<ul class="listtab">		
													<li> <i class="allservice fa fa-check-circle"></i> DJ DJ AND MUSIC</li>
													<li> <i class="allservice fa fa-check-circle"></i> DJ DJ AND MUSIC</li>
													<li> <i class="notallservice fa fa-times-circle"></i> DJ DJ AND MUSIC</li>
													<li> <i class="allservice fa fa-check-circle"></i> DJ DJ AND MUSIC</li>
													<li> <i class="notallservice fa fa-times-circle"></i> DJ DJ AND MUSIC</li>				
												</ul>
											</div>	
								...
								<div id="deals">
									<div class="pg-cus-rev">
										<div class="row">
											<div class="col-md-4 bxshadow">
												<div class="row">
													<div class="pglist-p3 pglist-bg pglist-p-com">
														<div class="pglist-p-com-ti pglist-p-com-ti-right">
														<h3><span>Deal</span> 1 </h3> </div>
														<div class="list-pg-inn-sp">
															<div class="list-pg-oth-info">
																<ul>
																	...
																	<a class="waves-effect waves-light btn-large full-btn" href="#!">View Details</a> 
						...
						<div class="col-md-12">
							<div class="pglist-p3 pglist-bg pglist-p-com" id="ld-roo">
								<div class="pglist-p-com-ti">
								<h3><span>Other</span>Related Doctors</h3> </div>
								<div class="list-pg-inn-sp">
									<div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
										...
										<div class="col-md-9 home-list-pop-desc trdescr"> 
											<div class="tr-location">
												...
												<span> <i class="fa fa-map-marker"></i>  Hills, Los Angeles, USA.</span>
											</div>
