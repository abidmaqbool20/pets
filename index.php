...
<?php include("includes/nav.php"); ?> 
 	...
 	<section class="com-padd sec-bg-white">
		<div class="container">
			<div class="row">
				<div class="com-title">
					<h2>Explore your <span>Featured Pets</span></h2>
					...
					<div class="">
						...
						<div class="col-md-6">
							...
							<div class="how-com">
								<ul>
									...
									<li> <img src="images/how/2.png" alt="">
										<h4>Get 1000+ Trusted Service</h4>
										<p>from over 60 Services to help you out in your works. There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
									</li>
									<li> <img src="images/how/3.png" alt="">
						...
						<div class="how-com">
							<ul>
								...
								<li> <img src="images/how/5.png" alt="">
									<h4>Get 1000+ Leads and Visitors</h4>
									<p>from over 60 Services to help you out in your works. There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
								</li>
								<li> <img src="images/how/6.png" alt="">
	...
	<section class="com-padd com-padd-redu-bot1 pad-bot-red-40 sec-bg-white"">
		<div class="container">
			<div class="row">
				<div class="com-title">
